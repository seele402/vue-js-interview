<template>
  <v-col cols="12" md="4">
    ...
    <v-select v-model="score" :items="scoreRanges" clearable label="Filter by score"
      @change="$emit('score-filter-changed', score)" @click:clear="$emit('score-filter-changed')"></v-select>
